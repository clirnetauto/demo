...
//Not Required for the US/EU Server.Its required only for the india 		
  ...
  //Notification dialog required for production
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='main_outlet']/div/div/div/div/div/div[3]/div/div[2]/div[3]/div/div/div[2]/div/div[2]/div/h2")));
        MobDriverInit.getDriver().findElement(By.xpath("//div[@id='main_outlet']/div/div/div/div/div/div[3]/div/div[2]/div[3]/div/div/div[2]/div/div[2]/div/h2")).click();
    	...
    	
    	{
        	...
        	MobDriverInit.getDriver().findElement(By.xpath("//div[@id='root']/div/nav/div/div[2]/span/i")).click();
...
//    		Assert.assertTrue(ele.isDisplayed());
    	...
    	
    	{
        	//WebDriverWait wait = new WebDriverWait(MobDriverInit.getDriver(),Duration.ofSeconds(10));
        	Thread.sleep(4000);
        	MobDriverInit.getDriver().findElement(By.xpath("//h4[contains(.,'CLIRNET PG Forum')]")).click();
        	Thread.sleep(5000);
